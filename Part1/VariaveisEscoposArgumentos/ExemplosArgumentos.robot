...
*** Variable ***
&{PESSOA}       nome=Isabela Silva   email=isabelasilva@exemplo.com.br   idade=22   sexo=feminino
...
*** Keywords ***
Uma keyword qualquer 01
    Uma subkeyword com argumentos   Jaqueline Silva   jaqueline_silva@teste.com.br
